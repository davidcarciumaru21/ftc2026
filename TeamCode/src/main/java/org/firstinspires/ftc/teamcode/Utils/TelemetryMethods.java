...
public final class TelemetryMethods {
     ...
     */
    public static void displayDriveModes(org.firstinspires.ftc.robotcore.external.Telemetry telemetry, DriveType gamepad1DriveType,  DriveType gamepad2DriveType) {
        telemetry.addLine("-----------------------------");
        if (gamepad1DriveType == DriveType.ROBOTCENTRIC) {
            telemetry.addData("Gamepad1 Drive-Type", "ROBOT-CENTRIC);
        } else {
            telemetry.addData("Gamepad1 Drive-Type", "FIELD-CENTRIC);
        }

        if (gamepad2DriveType == DriveType.ROBOTCENTRIC) {
            telemetry.addData("Gamepad2 Drive-Type", "ROBOT-CENTRIC);
        } else {
            telemetry.addData("Gamepad2 Drive-Type", "FIELD-CENTRIC);
        }
    }
    ...
    public static void displaySampleValidation(org.firstinspires.ftc.robotcore.external.Telemetry telemetry, AllianceColor AllianceColorVar) {
        ...
        if (AllianceColorVar == AllianceColor.RED) {
            telemetry.addData("Color Of The Alliance", "RED);
        } else if (AllianceColorVar == AllianceColor.BLUE) {
            telemetry.addData("Color Of The Alliance", "BLUE");
        }
    }
}
